            ...
            <div class="card-body">
              ...
              ?>
                    ...
                    <form class="row g-3" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-md-12">
                        <label for="" class="form-label-md"><b>Balas</b></label>
                        <textarea name="balasan" class="form-control" id="" cols="10" rows="5" ><?php echo $row['balasan'] ?></textarea>
                      </div>
                      <div class="col-md-1">
              ...
              if (isset($_POST['submit'])) {
                ...
                $update = mysqli_query($conn, "UPDATE kritik_saran SET
                           balasan = '$balasan'
